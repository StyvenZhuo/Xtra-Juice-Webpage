        ...
        <section class="container ">
            <div class="flex lg:mx-4">
                <div class="mt-28 ml-16 sm:ml-32 md:ml-48 xl:mx-12">
                    <div>
                        <h1 class="text-xl md:text-4xl font-bold font-sans text-hijau">Where Taste and Health</h1>
                        <h1 class="text-xl md:text-4xl mt-3 font-bold text-hijau">Blend Perfectly</h1>
                    </div>
                    ...
                    <a href=""></a>
                        <button class="mt-5 border text-md md:text-xl border-b-5 border-r-5 b-600 rounded-full border-4 ring ring-hijau bg-hijau text-white box-border h-8 w-24 md:h-12 md:w-36">
                            Explore
                        </button>
                    </a>
                </div>
                <div class="">
                    <!-- BUTUH PERBAIKAN -->
                    <img src="{{ asset('storage/images/orangebg.png') }}" alt="" class="h-120">
                </div>
            </div>
        </section>
